...
import { showCatalogue } from './src/views/catalogueView.js';
import { showCreateGame } from './src/views/createNewGameView.js';
import { showGameDetails } from './src/views/detailsView.js';
...
page('/details/:id', showGameDetails);
